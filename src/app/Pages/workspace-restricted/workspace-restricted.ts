...
@Component({
  selector: 'app-workspace-restricted-page',
  standalone: true,
  ...
  styles: [`
    ...
    .workpage-shell__panel {
      ...
      background:
        radial-gradient(circle at top left, rgba(248, 113, 113, 0.1), transparent 46%),
        rgba(9, 14, 28, 0.9);
    }
...
export class WorkspaceRestrictedPageComponent {}
